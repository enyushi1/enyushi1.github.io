...
1. **[Apr. 2024]** One collaborative paper titled ["Multi-agent Reinforcement Learning-based Joint Precoding and Phase Shift Optimization for RIS-aided Cell-Free Massive MIMO Systems"](https://zhewang77.github.io/files/Resource Allocation for Near-Field Communications Fundamentals, Tools, and Outlooks.pdf) is accepted by ***IEEE Transactions on Vehicular Technology*** (IF: 6.8, An1). The first author is my colleague [Yiyang Zhu](https://scholar.google.cz/citations?user=LWh42_8AAAAJ&hl=zh-CN&oi=sra). The paper code sharing on [GitHub](https://github.com/YiyangZYY/MARL-based_Joint_Precoding_and_Phase_Shift_Optimization_for_RIS-aided_Cell-Free_Massive_MIMO_Systems)
...
3. Hao Lei, **Zhe Wang**, Huahua Xiao, Jiayi Zhang, and Bo Ai, ["Uplink Performance of Cell-Free Extremely Large-Scale MIMO Systems,"](https://arxiv.org/abs/2301.12086) ***International Conference on Communications (ICC)***, 2023.  <i><font color="#C93756">We investigate the uplink performance of cell-free XL-MIMO systems with distributed signal processing schemes. </font> <i>
